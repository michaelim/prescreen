...
/** Source: Josh Hug's implementation of Plotter
...
public class Plotter {
    ...
    public static void plotCategoryWeights(NGramMap ngm, WordNet wn, String[] categoryLabels,
        ...
        Chart chart = new ChartBuilder().width(WIDTH).height(HEIGHT).xAxisTitle("years")
    ...
    public static void plotZipfsLaw(NGramMap ngm, int year) {
        ...
        Chart chart = new ChartBuilder().width(WIDTH).height(HEIGHT).xAxisTitle("rank")
